...
! https://github.com/SpecterOps/BloodHound-Legacy/releases
    ...
    (последний блуд) sudo apt install neo4j (по умолчанию neo4j neo4j) --> меняем на Silvercore_21
    (последний блуд) https://github.com/SpecterOps/BloodHound-Legacy/releases/tag/v4.3.1 (neo4j Silvercore_21)
